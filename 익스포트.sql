...
--------------------------------------------------------
  ...
  CREATE TABLE "INFINITY21_JSFMS"."AAA" 
   (	"TIME" TIMESTAMP (6), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "INFINITY21_JSFMS"."BBB" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "INFINITY21_JSFMS"."CCC" 
   (	"ID" NUMBER(19,0), 
	"CTIME" TIMESTAMP (6), 
	"OTIME" TIMESTAMP (6), 
	"DATATAG_NAME" NVARCHAR2(255), 
	"DATATAG_TYPE" CHAR(1 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "INFINITY21_JSFMS"."DDD" 
 ...
 NOCOMPRESS LOGGING
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table ICOM_ALARM_MASTER_XXX
--------------------------------------------------------

  CREATE TABLE "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX" 
   (	"ALARM_CODE" VARCHAR2(20 BYTE), 
	"ALARM_MESSAGE" VARCHAR2(1000 BYTE), 
	"ALARM_MESSAGE_ENG" VARCHAR2(1000 BYTE), 
	"ALARM_DESC" VARCHAR2(1000 BYTE), 
	"ALARM_GROUP_LVL1" VARCHAR2(50 BYTE), 
	"ALARM_GROUP_LVL2" VARCHAR2(50 BYTE), 
	"ALARM_GROUP_LVL3" VARCHAR2(50 BYTE), 
	"ALARM_DIVISION" VARCHAR2(20 BYTE) DEFAULT '*', 
	"ALARM_TYPE" VARCHAR2(20 BYTE) DEFAULT '*', 
	"ALARM_CLASS" VARCHAR2(20 BYTE) DEFAULT '*', 
	"PLC_CODE" VARCHAR2(20 BYTE) DEFAULT '*', 
	"MACHINE_CODE" VARCHAR2(20 BYTE) DEFAULT '*', 
	"WORKSTAGE_CODE" VARCHAR2(20 BYTE) DEFAULT '*', 
	"COMMENTS" VARCHAR2(1000 BYTE), 
	"ENTER_DATE" DATE DEFAULT SYSDATE, 
	"ENTER_BY" VARCHAR2(20 BYTE) DEFAULT 'SYSTEM', 
	"LAST_MODIFY_DATE" DATE DEFAULT SYSDATE, 
	"LAST_MODIFY_BY" VARCHAR2(20 BYTE) DEFAULT 'SYSTEM', 
	"ORGANIZATION_ID" NUMBER
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_CODE" IS '알람코드 또는 TAGID';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_MESSAGE" IS '알람한글메세지';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_MESSAGE_ENG" IS '알람영문메세지';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_DESC" IS '알람설명';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_GROUP_LVL1" IS '알람대분류';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_GROUP_LVL2" IS '알람중분류';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_GROUP_LVL3" IS '알람소분류';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_DIVISION" IS '알라구분(미정)';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_TYPE" IS '설비알람 또는 기타';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."ALARM_CLASS" IS '수동정지,자동정지';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."PLC_CODE" IS 'PLC코드 번호 PLC01,PLC02 , PLC03';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."MACHINE_CODE" IS '설비코드';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."WORKSTAGE_CODE" IS '공정코드';
   COMMENT ON COLUMN "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"."COMMENTS" IS '설명';
   COMMENT ON TABLE "INFINITY21_JSFMS"."ICOM_ALARM_MASTER_XXX"  IS '알람코드마스터 테이블( 사용안함 테그마스터로이관 )';
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Table ICOM_PLC_TAG_MASTER_BACK
--------------------------------------------------------

  CREATE TABLE "INFINITY21_JSFMS"."ICOM_PLC_TAG_MASTER_BACK" 
   (	"PLC_CODE" VARCHAR2(20 BYTE), 
	"TAG_ID" VARCHAR2(200 BYTE), 
	"TAG_ADDRESS" VARCHAR2(200 BYTE), 
	"TAG_NAME" VARCHAR2(200 BYTE), 
	"TAG_GROUP" VARCHAR2(100 BYTE), 
	"TAG_TYPE" VARCHAR2(200 BYTE), 
	"TAG_STATUS" VARCHAR2(20 BYTE), 
	"TAG_DIVISION" VARCHAR2(20 BYTE), 
	"TAG_VALUE_TYPE" VARCHAR2(20 BYTE), 
	"TAG_VALUE" VARCHAR2(30 BYTE), 
	"TAG_USE_YN" VARCHAR2(1 BYTE), 
	"TAG_DATA_TYPE" VARCHAR2(20 BYTE), 
	"TAG_UNIT" VARCHAR2(10 BYTE), 
	"TAG_SCALE" NUMBER, 
	"MACHINE_CODE" VARCHAR2(100 BYTE), 
	"COMMENTS" VARCHAR2(2000 BYTE), 
	"LAST_CHANGED_DATE" DATE, 
	"ENTER_DATE" DATE, 
	"ENTER_BY" VARCHAR2(20 BYTE), 
